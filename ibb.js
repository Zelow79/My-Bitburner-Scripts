...
export async function main(ns) {
	const [width, height] = [215, 690], b = ns.bladeburner;
	ns.ui.openTail(); ns.disableLog("ALL"); ns.ui.resizeTail(width, height); ns.clearLog();
	ns.ui.setTailTitle(tem("🔍BB:Info", { "font-family": 'Brush Script MT, cursive' }));
