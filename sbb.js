...
export async function main(ns) {
	ns.disableLog('ALL'); ns.ui.openTail(); ns.ui.setTailTitle(tem("🧍BB:Sleeves", { "font-family": 'Brush Script MT, cursive' }));
	...
	function printInfo() {
		...
		for (const steve of sleeves) {
			...
			ns.printRaw([React.createElement("span", {}, `Sleeve-${steve}    `), React.createElement("span", { style: { color: ns.ui.getTheme().int } }, "Int " + format(s.getSleeve(steve).skills.intelligence, 3))]);
