...
export async function main(ns) {
	...
	ns.clearLog(); ns.tail(); ns.resizeTail(600, 450);
	...
	ns.printRaw(React.createElement("div", { style: { margin: "auto", width: "100%" } }, React.createElement("img", { style: { margin: "auto", display: "block", width: "50%" }, src: "https://raw.githubusercontent.com/Zelow79/My-Bitburner-Scripts/main/resources/vegeta-scouter.gif" })));
	ns.printRaw(tableMaker(content, 4, { style: { border: "1px solid white", "border-collapse": "collapse", width: "90%", margin: "auto" } }, { style: { border: "1px solid white" } }));
}